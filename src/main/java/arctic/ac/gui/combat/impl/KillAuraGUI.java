...
public class KillAuraGUI {

    private Inventory inventory;

    public KillAuraGUI createNewGUI() {
        Inventory inv = Bukkit.createInventory(null, 27, "§b§lKillAura Checks");
    ...
    public void setItems() {
        ...
        for (String checkVariation : Arctic.INSTANCE.getConfig().getConfigurationSection("checks.combat" + "." + "killaura").getKeys(false)) {
            checks.add("killaura" + checkVariation);
            checkAndActive.put("killaura" +  checkVariation, Arctic.INSTANCE.getConfig().getBoolean("checks.combat." + "killaura" + "." + checkVariation + ".enabled"));
