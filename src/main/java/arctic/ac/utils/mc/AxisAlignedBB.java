...
public class AxisAlignedBB
{
    ...
    public AxisAlignedBB(net.minecraft.server.v1_8_R3.AxisAlignedBB axisAlignedBB) {
    ...
    public double distanceXZ(final double x, final double z) {
        final double dx = Math.min(Math.pow(x - this.maxX, 2.0), Math.pow(x - this.maxX, 2.0));
        final double dz = Math.min(Math.pow(z - this.maxZ, 2.0), Math.pow(z - this.maxZ, 2.0));
