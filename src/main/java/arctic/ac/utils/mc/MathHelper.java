...
public class MathHelper {
     ...
     * of the result of multiplying a 32-bit unsigned integer by the B(2, 5) De Bruijn HealFightAC 0x077CB531.  Value
    ...
    /**
     * Uses a B(2, 5) De Bruijn HealFightAC and a lookup table to efficiently calculate the log-base-two of the given
