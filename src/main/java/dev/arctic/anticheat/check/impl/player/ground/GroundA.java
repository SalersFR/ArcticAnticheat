...
public class GroundA extends Check {
    ...
    public void handle(Packet packet, long time) {
        if(packet.isFlyingFR()) {
            final WrapperPlayClientFlying wrapperPlayClientFlying = new WrapperPlayClientFlying(packet);

            final boolean clientGround = wrapperPlayClientFlying.getOnGround();
