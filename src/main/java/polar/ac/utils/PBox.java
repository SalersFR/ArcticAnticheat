...
public class PBox {
    ...
    public PBox(final PLocation location) {
        this(location.getX(), location.getY(), location.getZ());
    }

    public PBox(final double x, final double y, final double z) {
        this(x, x, y, y, z, z);
    }

    public PBox(final PLocation PLocation, final PLocation PLocation2) {
    ...
    public PBox(final double x1, final double x2, final double y1, final double y2, final double z1, final double z2) {
        this.x1 = x1;
        this.x2 = x2;
        this.y1 = y1;
        this.y2 = y2;
    ...
    public PBox add(final PBox other) {
        this.x1 += other.x1;
        this.x2 += other.x2;
        this.y1 += other.y1;
        this.y2 += other.y2;
    ...
    public PBox move(final double x, final double y, final double z) {
        this.x1 += x;
        this.x2 += x;
        this.y1 += y;
        this.y2 += y;
    ...
    public PBox expand(final double x, final double y, final double z) {
        this.x1 -= x;
        this.x2 += x;
        this.y1 -= y;
        this.y2 += y;
    ...
    public boolean contains(final PLocation location) {
    ...
    public boolean checkBlocks(final World world, final Predicate<Material> predicate) {
        return PBox.checkBlocks(this.getBlocks(world), predicate);
    }
    ...
    public double distanceXZ(final PLocation loc) {
